    ...
    <div className="flex my-4">
      ...
      <div className="flex flex-col justify-between py-4">
        ...
        <div className="flex justify-between">
          <button className="shadow rounded-lg p-2 bg-gray-800 hover:bg-gray-900 text-white mr-2 duration-200 text-sm">
            Thêm vào giỏ
          </button>
          <button className="shadow rounded-lg p-2 bg-gray-100 hover:bg-gray-200 text-sm">Chi tiết</button>
        </div>
      </div>
    </div>
  );
