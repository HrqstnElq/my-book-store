				...
				<section className="text-gray-700 body-font lg:space-x-4 flex flex-col lg:flex-row">
					<div className="lg:mr-10 mb-10">
						...
						<div className="flex justify-between mt-4">
							...
							<button className="w-24 px-2 py-1 rounded text-white focus:outline-none bg-red-400 hover:bg-red-500 shadow-sm transition active:bg-red-600">
								Xóa
							</button>
						</div>
					</div>
					<div className="h-96">
						...
						<section
							className="description border p-2 rounded-lg overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-200"
							style={{height: "19rem"}}>
							<h4 className="text-lg font-semibold">Mô tả </h4>
							<span dangerouslySetInnerHTML={{__html: bookDetail.description}}></span>
						</section>
